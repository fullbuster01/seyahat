                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" id="category_id" class="form-control">
                                    <option disabled selected>Plilih salah satu!</option>
                                        ...
                                        <option {{ $category->id == $item->category_id ? 'selected' : '' }} value="{{ old('category') ?? $category->id }}">{{ $category->name }}</option>
                                        @endforeach
                                </select>
                                @error('category_id')
                                ...
                                <select name="country_id" id="country_id" class="form-control">
                                    <option disabled selected>Plilih salah satu!</option>
                                        @foreach ($countries as $country)
                                            <option {{ $country->id == $item->country_id ? 'selected' : '' }} value="{{ old('country_id') ?? $country->id }}">{{ $country->name }}</option>
                                        @endforeach
                                </select>
                                @error('country_id')
                                    <div class="text-danger mt-2">
