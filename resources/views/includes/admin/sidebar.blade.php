        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard') }}">
            <div class="sidebar-brand-text mx-3">Seyahat Admin</div>
        </a>
        ...
        <li class="nav-item {{ request()->is('admin/thumb*') ? ' active' : '' }}">
            <a class="nav-link" href="{{ route('thumb.index') }}">
            <i class="fas fa-fw fa-images"></i>
            <span>Galeri Thumb</span></a>
        </li>
