          ...
          <![endif]-->
              <div class="mj-column-per-100 mj-outlook-group-fix"
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
                  ...
                  <tr>
                    <td align="center"
                      style="font-size:0px;padding:10px 25px;padding-top:25px;padding-right:0px;padding-bottom:25px;padding-left:0px;word-break:break-word;">
                      <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                        style="border-collapse:collapse;border-spacing:0px;">
                        <tbody>
                          <tr>
                            <td style="width:170px;">
                              <img alt="logo" height="auto" src="{{ url('frontend/images/logo@2x.png') }}"
                        ...
                        <tbody>
                            <tr>
                                <td style="width:500px;" >
                                    <img alt="tempat wisata" height="auto" src="{{ url('storage/'. $data->travel_package->thumb->first()->l) }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="500"/>
                                </td>
                            </tr>
                        </tbody>
                      </table>
                          ...
                          <tr>
                            <td align="left"
                              ...
                              <div
                                ...
                                Hi, {{ $data->user->name }} <br><br> Tiket digital kamu sudah berhasil dicetak. <br>Booking ID
                            ...
                            <td align="left"
                              ...
                              <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                ...
                                <tr>
                                  ...
                                  <td style="text-align:right;">{{ \Carbon\Carbon::now()->addDays(14)->format('F d, Y') }}</td>
                                </tr>
                                <tr>
                              ...
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                  <td align="center" bgcolor="#FF9E53" role="presentation"
                                    style="border:none;border-radius:4px;cursor:auto;mso-padding-alt:10px 25px;background:#FF9E53;"
                                    valign="middle">
                                    <a href="{{ url('checkout/'. $data->id) }}"
                                      style="display:inline-block;background:#FF9E53;color:#ffffff;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:4px;">
                                      Check Details </a>
                                  </td>
                                </tr>
                              </table>
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" border="0"
                        ...
                        <tr>
                          ...
                          <td
                            ...
                            support@seyahat.id<br> 021-2222-4444 </td>
                        </tr>
                      </table>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td align="center"
                      ...
                      <div
                        ...
                        2020 Seyahat Copyright All Rights Reserved.</div>
                    </td>
                  </tr>
                </table>
              </div>
